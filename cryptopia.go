// cryptopia public api API implementation.
//
// API Doc: https://www.cryptopia.co.nz/Forum/Thread/255
//
package cryptopia
...
func init() {
	...
	logger = logrus.WithField("prefix", "[api:cryptopia]")
